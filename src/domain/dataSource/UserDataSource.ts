import { LoginUserDto, RegisterUserDto, UpdateUserDto, TokenUserDto, ChangePasswordUserDto, User } from "..";
...
export abstract class UserDataSource {
  ...
  abstract refreshToken(token: TokenUserDto): Promise<TokenUserDto>;
